    ...
    return (
        <Box>
            <Box position="relative" overflow="hidden">
                <Box bg="gray20" height={284} py={74} px={["default", "lg", 250]}>
            ...
            <Box
              mt={["xl", "xl", "-80px"]} mb={"xl"} mx={[0, 0, 0, 'auto']}
              px={['default', 'lg', 'xxl', '0']} position="relative"
              flex flexDirection="row" flexWrap="wrap" width={[1, 1, 1, 1024]}
            >
